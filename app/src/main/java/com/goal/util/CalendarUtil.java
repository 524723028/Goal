...
public class CalendarUtil {
    ...
    public static boolean compare(Date compareDate, Date currentDate) {
        ...
        String s=currentDate.getYear()+"-"+(currentDate.getMonth())+"-"+currentDate.getDay();

        //System.out.println("\n时间:"+String.valueOf(currentDate.get(Calendar.YEAR)+"-"+(currentDate.get(Calendar.MONTH))+"-"+currentDate.get(Calendar.DAY_OF_MONTH)));
        ...
        return chineseDateFormat.format(compareDate).compareTo(chineseDateFormat.format( myDate)) >= 0;
    }
